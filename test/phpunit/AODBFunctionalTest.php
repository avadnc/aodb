...
/**
 * \file    test/phpunit/AODBFunctionalTest.php
 * \ingroup aodb
 ...
 * @package Testaodb
 */
class AODBFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/aodb/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('aodb/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/aodb/admin/about.php');
		$this->authenticate();
		return $this->assertContains('aodb/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('aodbwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modAODB_AODBTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modAODB_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
