  ...
  <link
      href="{$dol_url_root}/custom/aodb/engine/templates/content/ejthemes/default-theme/ej.web.all.min.css"
      rel="stylesheet" />
  <link href="{$dol_url_root}/custom/aodb/engine/templates/content/default.css" rel="stylesheet" />
  <link href="{$dol_url_root}/custom/aodb/engine/templates/content/default-responsive.css"
      rel="stylesheet" />
  <link
      href="{$dol_url_root}/custom/aodb/engine/templates/content/ejthemes/responsive-css/ej.responsive.css"
      rel="stylesheet" />
  <!--[if lt IE 9]>
       <script type="text/javascript" src="../scripts/jquery-1.11.3.min.js" ></script>
      <![endif]-->
  <!--[if gte IE 9]><!-->
  <script src="{$dol_url_root}/custom/aodb/engine/templates/scripts/jquery-3.4.1.min.js"
      type="text/javascript">
  </script>
  <!--<![endif]-->
  <script src="{$dol_url_root}/custom/aodb/engine/templates/scripts/jsrender.min.js"></script>
  <script src="{$dol_url_root}/custom/aodb/engine/templates/scripts/ej.web.all.min.js"
      type="text/javascript">
  </script>
  <script src="{$dol_url_root}/custom/aodb/engine/templates/scripts/properties.js"
      type="text/javascript">
  </script>
  <script src="{$dol_url_root}/custom/aodb/engine/templates/scripts/jsonganttdata.js"></script>
